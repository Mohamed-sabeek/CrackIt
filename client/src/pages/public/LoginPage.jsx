...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center p-4 relative overflow-hidden font-sans select-none">
      ...
      {/* Sleek blurred radial gradient circles */}
        ...
        <div className="bg-white/[0.03] backdrop-blur-xl border border-white/[0.08] p-8 rounded-3xl shadow-2xl relative">
          ...
          {errorMsg && (
            <motion.div 
              ...
              className="flex items-start gap-3 p-3.5 mb-6 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400 text-sm leading-relaxed"
            >
          ...
          {successMsg && (
            <motion.div 
              initial={{ opacity: 0, scale: 0.95 }}
              animate={{ opacity: 1, scale: 1 }}
              className="flex items-start gap-3 p-3.5 mb-6 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-sm leading-relaxed"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-xs font-medium text-slate-500 hover:text-blue-400 cursor-pointer transition-colors duration-200">
                  Forgot Password?
                </span>
              </div>
              <div className="relative">
